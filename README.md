...
php7.4-apcu php7.4-ldap php7.4-snmp php7.4-pgsql php7.4-sockets php7.4-redis;
```
...
php8.0-apcu php8.0-ldap php8.0-snmp php8.0-pgsql php8.0-sockets php8.0-redis;
```
...
php8.1-apcu php8.1-ldap php8.1-snmp php8.1-pgsql php8.1-sockets php8.1-redis;
```
...
php8.2-apcu php8.2-ldap php8.2-snmp php8.2-pgsql php8.2-sockets php8.2-redis;
```
...
php8.3-apcu php8.3-ldap php8.3-snmp php8.3-pgsql php8.3-sockets php8.3-redis;
```
...
php8.4-apcu php8.4-ldap php8.4-snmp php8.4-pgsql php8.4-sockets php8.4-redis;
```
